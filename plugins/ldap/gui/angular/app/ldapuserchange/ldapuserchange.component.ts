...
@Component({selector: 'app-ldapuserchange', templateUrl: './ldapuserchange.component.html'})


// Component Export Definition
export class LDAPUserChangeComponent implements OnInit {
  ...
  objectName = 'LDAPUserChange';
  objectDefinition = 'LDAPUserChange';
